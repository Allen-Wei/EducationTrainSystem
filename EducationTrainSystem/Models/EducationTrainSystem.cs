...
namespace EducationTrainSystem.Models
{
	...
	public partial class Registration : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private string _RegTrainName;
		
		private System.Nullable<System.Guid> _RegTrainId;
    ...
    partial void OnRegTrainNameChanging(string value);
    partial void OnRegTrainNameChanged();
    partial void OnRegTrainIdChanging(System.Nullable<System.Guid> value);
    partial void OnRegTrainIdChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_RegTrainName", DbType="VarChar(500)")]
		public string RegTrainName
		{
			get
			{
				return this._RegTrainName;
			}
			set
			{
				if ((this._RegTrainName != value))
				{
					this.OnRegTrainNameChanging(value);
					this.SendPropertyChanging();
					this._RegTrainName = value;
					this.SendPropertyChanged("RegTrainName");
					this.OnRegTrainNameChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_RegTrainId", DbType="UniqueIdentifier")]
		public System.Nullable<System.Guid> RegTrainId
		{
			get
			{
				return this._RegTrainId;
			}
			set
			{
				if ((this._RegTrainId != value))
				{
					this.OnRegTrainIdChanging(value);
					this.SendPropertyChanging();
					this._RegTrainId = value;
					this.SendPropertyChanged("RegTrainId");
					this.OnRegTrainIdChanged();
				}
			}
		}
